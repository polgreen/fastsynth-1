...
(define-fun init-fn ((x (Array (_ BitVec 32) (_ BitVec 32)))) Bool 
	(forall ((index (BitVec 32))) (=> (bvult index (_ bv1000 32))(= (select x index) index))))


(define-fun trans-fn ((x (Array (_ BitVec 32) (_ BitVec 32)))(x! (Array (_ BitVec 32) (_ BitVec 32)))) Bool 
	(forall ((index (BitVec 32))) (=> (bvult index (_ bv1000 32))(= (select x! index) (bvadd (select x index) (_ bv1 32))))))


(define-fun post-fn ((x (Array (_ BitVec 32) (_ BitVec 32)))) Bool 
(forall ((index (BitVec 32))) 
	(=> (bvult index (_ bv100 32)) (bvule (select x index) (select x (bvadd index (_ bv1 32)))))))
